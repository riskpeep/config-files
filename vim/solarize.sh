...
case "$1" in 
  "dark")
    ...
    PALETTE="#03031b1b2121:#D3D301010202:#858599990000:#B5B589890000:#26268B8BD2D2:#D3D336368282:#2A2AA1A19898:#EEEEE8E8D5D5:#000015151B1B:#CBCB4B4B1616:#58586E6E7575:#65657B7B8383:#838394949696:#6C6C7171C4C4:#9393A1A1A1A1:#FDFDF6F6E3E3"
    BG_COLOR="#00002B2B3636"
    BG_COLOR="#000012121D1D"
    FG_COLOR="#65657B7B8383"
    FG_COLOR="#8A8AA8A8B3B3"
;;
  "light")
